...
{
    [TestClass]
    public class CrearPreguntaControllerTest
    {
        CrearPreguntaController preguntacontroller = new CrearPreguntaController();
        ...
        {
            var resultado = await preguntacontroller.Index();
